<template>
  ...
  >
    <template #intro>
      <q>力道輕柔節奏和緩容易上手，是兼具舒壓及療效的入門按摩療法。</q>
      <p>
        在眾多按摩技法中，英式芳療按摩手法以淋巴引流的架構為主，同時帶入部分肌肉按摩的手法，因此按摩時不將力道集中在某一點，而是順淋巴的方向撫按，不但可以達到淋巴引流的排毒效果，同時也能在局部肌肉帶來舒緩的效果。
      </p>
      <p>
        英式芳療按摩手法輕柔和緩，不帶傳統按摩的侵略性，但仍然具有舒緩身心的功用，能幫助個案卸下身心防備，進入深層解放休息。
      </p>
      <p>
    ...
    <template #feature>
      <ol>
        <li>本課程將教授完整英式芳療按摩療程操作。</li>
        <li>
          課程內容包含個案諮商、配方調製、背部、肩頸部、頭部、手部、腿部、腹部、臉部之操作示範與實習。
        </li>
        <li>符合IFPA芳療協會專業芳療師會員資格的要求。</li>
        <li>本課程手法考試通過後將核發技法修業證書。</li>
      </ol>
    </template>
    <template #payment>
      <ul>
