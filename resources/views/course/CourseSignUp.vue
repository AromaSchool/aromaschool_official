      ...
      <form class="contact_form_block">
        ...
        <div class="form_box">
          <label for="inputCourse" class="form_label"
            >您感興趣的課程 (可複選)<span class="hint">*</span></label
          >
              ...
              <div class="check_box_group">
                ...
                <div class="form-check">
                  <input
                    ...
                    value="aromatherapy_intermediate"
                  />
                  <label
